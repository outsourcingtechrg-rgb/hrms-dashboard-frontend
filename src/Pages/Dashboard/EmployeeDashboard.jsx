...
const _CSS = `
  ...
  .ed-page  { background:var(--ed-bg); color:var(--ed-text-1); }
...
function Card({ title, children, action }) {
  return (
    ...
    >
      ...
      >
        <span
          style={{ fontSize: 13, fontWeight: 600, color: "var(--ed-text-2)" }}
        >
          {title}
        </span>
        {action}
    ...
    >
      ...
      <div style={{ minWidth: 0 }}>
        ...
        {loading ? (
          <div
            className="ed-skel"
            style={{ height: 28, width: 64, marginTop: 4 }}
          />
        ) : (
          <h3
            style={{
    ...
    >
      <span
        style={{
          ...
          height: 6,
          borderRadius: "50%",
          background: STATUS_DOT_COLOR[status] || "#94a3b8",
        }}
      />
      {status}
    </span>
...
function Empty({ icon: Icon, text }) {
  return (
    ...
    >
      ...
      <p style={{ fontSize: 13, color: "var(--ed-text-3)", margin: 0 }}>
        {text}
      </p>
    </div>
  );
      ...
      >
        ...
        <span
          style={{
            ...
            color: "var(--st-late-tx)",
            border: "1px solid var(--st-late-bd)",
          }}
        >
    ...
    <div>
            ...
            week.map((day) => {
              ...
              return (
                <rect
                  ...
                  fill={fill}
                  opacity={alpha}
                  stroke={isH ? (isDark ? "#f1f5f9" : "#1e293b") : "none"}
      ...
      {tooltip && (
        ...
        >
          <div
            className="ed-card"
            style={{ padding: "10px 14px", minWidth: 140, fontSize: 12 }}
          >
            <p
              style={{
                fontWeight: 700,
            ...
            >
              <span
                style={{
                  ...
                  height: 8,
                  borderRadius: "50%",
                  background: cellFill(tooltip.status, isDark),
                }}
              />
            ...
            {tooltip.in && (
              <p style={{ margin: "2px 0", color: "var(--ed-text-2)" }}>
                In: {fmt12(tooltip.in)}
              </p>
            )}
            {tooltip.out && (
              <p style={{ margin: "2px 0", color: "var(--ed-text-2)" }}>
                Out: {fmt12(tooltip.out)}
              </p>
            )}
            {tooltip.hours && (
              <p style={{ margin: "2px 0", color: "var(--ed-text-2)" }}>
                Hours: {fmtHours(tooltip.hours)}
              </p>
            )}
          </div>
        </div>
...
const APP_STATUS_CFG = {
  Pending: {
    bgVar: "var(--st-late-bg)",
    bdVar: "var(--st-late-bd)",
    txVar: "var(--st-late-tx)",
    Icon: Clock,
  },
  HOD_Approved: {
    bgVar: "var(--st-early-bg)",
    bdVar: "var(--st-early-bd)",
    txVar: "var(--st-early-tx)",
    Icon: ThumbsUp,
  },
  HOD_Rejected: {
    bgVar: "var(--st-absent-bg)",
    bdVar: "var(--st-absent-bd)",
    txVar: "var(--st-absent-tx)",
    Icon: ThumbsDown,
  },
  Approved: {
    bgVar: "var(--st-present-bg)",
    bdVar: "var(--st-present-bd)",
    txVar: "var(--st-present-tx)",
    Icon: CheckCircle2,
  },
  Rejected: {
    bgVar: "var(--st-absent-bg)",
    ...
    >
      ...
      >
        ...
        <div style={{ minWidth: 0 }}>
          ...
          <p style={{ fontSize: 10, color: "var(--ed-text-3)", margin: 0 }}>
  ...
  return (
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        <span
          style={{
            ...
            height: 6,
            borderRadius: "50%",
            background: STATUS_DOT_COLOR[rec.status] || "#94a3b8",
            flexShrink: 0,
          }}
        />
        <div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
        {rec.hours && (
          <span
            style={{ fontSize: 10, color: "var(--ed-text-3)", fontWeight: 500 }}
          >
            {fmtHours(rec.hours)}
          </span>
        )}
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        /* keep JWT-based fallback values */
      }
    })();
    return () => {
      ignore = true;
  ...
  const pillStyle = (() => {
    if (todayLoad)
      return {
        background: "var(--ed-hover)",
        color: "var(--ed-text-3)",
        borderColor: "var(--ed-border-md)",
      };
    if (todayStatus === "Present")
      return {
        background: "var(--st-present-bg)",
        color: "var(--st-present-tx)",
        borderColor: "var(--st-present-bd)",
      };
    if (todayStatus === "Late")
      return {
        background: "var(--st-late-bg)",
        color: "var(--st-late-tx)",
        borderColor: "var(--st-late-bd)",
      };
    return {
      background: "var(--ed-surface)",
      color: "var(--ed-text-2)",
    ...
    <div className="ed-page" style={{ padding: "32px 20px" }}>
        ...
        >
          <span
            style={{
              ...
              height: 8,
              borderRadius: "50%",
              background: STATUS_DOT_COLOR[todayStatus] || "var(--ed-text-4)",
              flexShrink: 0,
            }}
          />
      ...
      >
        <StatWidget
          ...
          Icon={LogIn}
          iconBg="var(--ic-green-bg)"
          iconColor="var(--ic-green-fg)"
          loading={todayLoad}
        />
        ...
        <StatWidget
          ...
          Icon={LogOut}
          iconBg="var(--ic-red-bg)"
          iconColor="var(--ic-red-fg)"
          loading={todayLoad}
        />
        ...
        <StatWidget
          ...
          Icon={Hourglass}
          iconBg="var(--ic-violet-bg)"
          iconColor="var(--ic-violet-fg)"
          loading={appLoad}
        />
      </div>
        ...
        >
          ...
          <span
            style={{
              ...
              gap: 6,
              padding: "6px 12px",
              background: "var(--st-early-bg)",
              border: "1px solid var(--st-early-bd)",
              borderRadius: 99,
              fontSize: 12,
              fontWeight: 600,
              color: "var(--st-early-tx)",
            }}
          >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            {todayLoad ? (
              ...
              <div>
                {[
                  {
                    label: "Status",
                    value: <StatusBadge status={todayRec.status} />,
                  },
                  {
                    label: "In",
                    value: (
                    ...
                    value: (
                      <span
                        style={{
                          ...
                          borderRadius: 99,
                          background:
                            todayRec.attendance_mode === "remote"
                              ? "var(--st-early-bg)"
                              : "var(--ed-hover)",
                          color:
                            todayRec.attendance_mode === "remote"
                ...
                {[
                  ...
                  return (
                    <div key={label}>
                      ...
                      >
                        <span
                          style={{ color: "var(--ed-text-2)", fontWeight: 500 }}
                        >
                          {label}
                        </span>
        ...
        >
          ...
          <ComingSoonCard
            title="Policies"
            icon={Shield}
            iconBg="var(--ic-blue-bg)"
            iconColor="var(--ic-blue-fg)"
            description="Access and acknowledge your company policies from this card."
          />
          <ComingSoonCard
            title="Training & Learning"
            icon={GraduationCap}
            iconBg="var(--ic-amber-bg)"
            iconColor="var(--ic-amber-fg)"
