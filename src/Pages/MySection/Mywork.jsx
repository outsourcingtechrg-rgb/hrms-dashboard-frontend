...
const isAssignedToCurrentUser = (ticket, user) => {
  ...
  return (
    ...
    sameId(ticket.assignee_id, employeeId) ||
    sameId(ticket.assigned_to_id, employeeId)
  );
};
...
function AssigneeSidebar({
  ...
  const handleDownload = async (att) => {
    ...
    try {
      await atDownload(API.downloadAtt(att.id), att.file_name);
    } catch (e) {
      addToast(e.message, "error");
    } finally {
      setDownloading(null);
    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          display: "flex",
          flexDirection: "column",
          boxShadow: "-6px 0 48px rgba(26,26,46,0.12)",
          borderLeft: "1px solid #e4e4ec",
        }}
      >
        {/* Header */}
        <div
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                ...
                <div>
                  ...
                  >
                    ...
                    {ticket.employee?.department?.department && (
                      <span
                        style={{
                          fontSize: 12,
                          color: "#8b8ba0",
            ...
            >
              ...
              >
                {[
                  ...
                  {
                    label: "Assignee",
                    value: ticket.assigned_to_name || "You",
                  },
                ].map(({ label, value }) => (
                  <div
                    key={label}
                  ...
                  {atts.map((a) => (
                    ...
                    >
                      ...
                      >
                        <Paperclip
                          size={12}
                          style={{ color: "#8b8ba0", flexShrink: 0 }}
                        />
                        <span
                          style={{
                            fontSize: 13,
                      ...
                      >
                        {downloading === a.id ? (
                          <Loader2 size={11} className="at-spin" />
                        ) : (
                          <Download size={11} />
                        )}
            ...
            <div style={{ padding: "16px 24px" }}>
              ...
              {comments.length === 0 ? (
                <div style={{ textAlign: "center", padding: "28px 0" }}>
                  ...
                  />
                  <p style={{ fontSize: 12, color: "#8b8ba0", margin: 0 }}>
                    No comments yet
                  </p>
                </div>
              ) : (
                  ...
                  {comments.map((c, i) => (
                    <div
                      ...
                      style={{
                        borderRadius: 14,
                        padding: "12px 14px",
                        background: c.is_hr ? "#eef2ff" : "#f4f4f8",
                        border: `1px solid ${c.is_hr ? "#c7d2fe" : "#e4e4ec"}`,
                      }}
                    >
                      <div
                        style={{
                      ...
                      >
                        <div
                          style={{
                            ...
                            alignItems: "center",
                            justifyContent: "center",
                            background: c.is_hr ? "#4f46e5" : "#1a1a2e",
                            color: "#fff",
                            fontSize: 10,
                            fontWeight: 700,
                            flexShrink: 0,
        ...
        {canResolve && (
          <div style={{ padding: "16px 24px", borderTop: "1px solid #e4e4ec" }}>
            ...
            >
              {resolving ? (
                <Loader2 size={13} className="at-spin" />
              ) : (
...
export default function AssignedTickets() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      setCurrentUser(me);
      const list = Array.isArray(allTickets)
        ? allTickets
        : allTickets.items || [];
  ...
  if (!loading && tickets.length === 0 && currentUser)
    return (
      <div
        className="at-root"
        style={{
      ...
      >
        <div style={{ textAlign: "center", maxWidth: 360, padding: "0 24px" }}>
          ...
          <h2
            className="at-serif"
            style={{ fontSize: 26, color: "#1a1a2e", margin: "0 0 10px" }}
          >
            No Assigned Tickets
          </h2>
          <p
          ...
          >
            You don't have any tickets assigned to you right now. When HR
            assigns a ticket, it will appear here.
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div
      className="at-root"
      style={{ minHeight: "100vh", background: "#f4f4f8" }}
    >
      <Toast toasts={toasts} />
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "40px 24px" }}>
        ...
        >
          <div>
            ...
            <h1
              className="at-serif"
              style={{ fontSize: 36, margin: 0, color: "#1a1a2e" }}
            >
              My Work Queue
            </h1>
        ...
        >
          {[
            ...
            >
              ...
              <p
                className="at-serif"
                style={{ fontSize: 36, color: text, margin: 0, lineHeight: 1 }}
              >
                {value}
              </p>
            </div>
        ...
        >
          ...
          >
            ...
            <span
              style={{ marginLeft: "auto", fontSize: 12, color: "#8b8ba0" }}
            >
          ...
          {paged.length === 0 ? (
            <div style={{ textAlign: "center", padding: "80px 20px" }}>
              ...
              />
              <p style={{ fontSize: 14, color: "#8b8ba0", margin: 0 }}>
